    ...
    <nav class="navbar navbar-expand-lg navbar-dark elegant-color" style="font-size: 85%">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link"
                       href="/admin/secure/brands/<?= DataManager::getInstance()->getDataByKey('admin-href') ?>">Brands</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                       href="/admin/secure/category/<?= DataManager::getInstance()->getDataByKey('admin-href') ?>">Categories</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active"
                       href="/admin/secure/products/<?= DataManager::getInstance()->getDataByKey('admin-href') ?>">Products</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                ...
                <li class="nav-item active">
                    <a class="nav-link"
                       href="/admin/secure/employee/<?= DataManager::getInstance()->getDataByKey('admin-href') ?>">Employees</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
