...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/views/admin/css/dataTables.bootstrap4.css"/>
        ...
        <ul class="list-unstyled">
            ...
            <li class="active"><a  href="#products" aria-expanded="false" data-toggle="collapse"> <i class="icon-new-file"></i>Products</a>
                <ul id="products" class="collapse list-unstyled ">
                    <li class="active"><a href="/<?php echo $this->getThisUrl(); ?>products/all">All Products</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="block">
                            ...
                            <table id="example_id" class="table table-striped table-active">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
...
<script type="text/javascript" src="/views/admin/vendor/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/views/admin/vendor/jquery.cookie/jquery.cookie.js"> </script>
<script type="text/javascript" src="/views/admin/vendor/chart.js/Chart.min.js"></script>
<script type="text/javascript" src="/views/admin/js/charts-home.js"></script>
<script type="text/javascript" src="/views/admin/js/front.js"></script>
<script type="text/javascript" src="/views/admin/js/jquery.dataTables.js"></script>
<script type="text/javascript" src="/views/admin/js/dataTables.bootstrap4.js"></script>
<script type="text/javascript" src="/views/admin/js/get-all-products.js"></script>
</body>
</html>
